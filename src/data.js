...
export const data = {
    en: {
        heroSectionData: {
            ...
            subtitle: "...who likes to craft solid and scalable frontend products with great user experiences.",
    ...
    tr: {
        heroSectionData: {
            ...
            subtitle: "...sağlam ve ölçeklenebilir frontend ürünleri oluşturmayı seven biri.",
            buttonIcon1: "fa-brands fa-github",
            buttonText1: "Github",
            buttonIcon2: "fa-brands fa-linkedin-in",
            buttonText2: "Linkedin",
        ...
        footerData: {
            ...
            subtitle: "Bir sorunuz veya öneriniz var mı, yoksa sadece merhaba mı demek istiyorsunuz? Buyurun.",
            socials: {
                icon1: "fa-brands fa-twitter",
                icon2: "fa-brands fa-codepen",
                icon3: "fa-solid fa-at",
